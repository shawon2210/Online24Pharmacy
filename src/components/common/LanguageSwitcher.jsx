...
export default function LanguageSwitcher() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute -bottom-9 left-1/2 -translate-x-1/2 px-2.5 py-1 bg-card/90 backdrop-blur-sm text-foreground text-xs font-medium rounded-lg opacity-0 group-hover:opacity-100 group-focus-visible:opacity-100 transition-opacity whitespace-nowrap pointer-events-none shadow-xl">

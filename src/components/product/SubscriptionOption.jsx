  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 mt-4">
      ...
      <button
        ...
        className="w-full bg-gradient-to-r from-emerald-600 to-cyan-600 text-white py-2 px-4 rounded-md hover:from-emerald-700 hover:to-cyan-700 disabled:opacity-50 text-sm font-medium transition-all duration-300"
      >

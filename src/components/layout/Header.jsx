...
export default function Header() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("orientationchange", handleNavVisibility, {
      passive: true,
    });
    return () => {
  ...
  return (
    <>
      ...
      >
        {/* Top Info Bar */}
        <div className="hidden md:block border-b border-white/10 bg-emerald-700/20">
      ...
      {/* Navigation */}
      <nav
        className={`hidden lg:block w-full bg-gradient-to-r from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 border-b-2 border-gray-200 dark:border-gray-700 shadow-md relative z-40 transition-transform duration-200 ease-out ${
          isNavVisible

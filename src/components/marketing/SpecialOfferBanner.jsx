...
export default function SpecialOfferBanner() {
  ...
  return (
    <section className="w-full relative overflow-hidden min-h-[90px] xs:min-h-[100px] sm:min-h-[110px] md:min-h-[120px] bg-gradient-to-r from-emerald-600 via-emerald-500 to-cyan-600 dark:from-emerald-700 dark:via-emerald-700 dark:to-cyan-700 text-white shadow-xl">

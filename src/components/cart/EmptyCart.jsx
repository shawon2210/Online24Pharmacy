...
export default function EmptyCart() {
  ...
  return (
    <div className="w-full mx-auto px-4 sm:px-6 md:max-w-4xl lg:max-w-6xl xl:max-w-7xl">
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 sm:p-12 lg:p-16 text-center">
        <div className="inline-flex items-center justify-center w-16 sm:w-20 h-16 sm:h-20 rounded-full bg-gray-100 mx-auto mb-4 sm:mb-6">
          <ShoppingCartIcon className="w-8 sm:w-10 h-8 sm:h-10 text-gray-400" />
        </div>
        ...
        <Link
          to={ROUTES.PRODUCTS}
          className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-green-600 text-white px-6 sm:px-8 py-3 sm:py-3.5 rounded-xl font-bold hover:from-emerald-700 hover:to-green-700 transition-all shadow-md hover:shadow-lg active:scale-95 text-sm sm:text-base"
        >

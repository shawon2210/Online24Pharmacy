...
export default function CategoriesListPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-gray-50">
      <SEOHead
        title="Browse All Categories - Online24 Pharmacy"
        description="Explore our wide range of medical categories including medicines, surgical equipment, diagnostics, and more."
        url="/categories"
      />
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Explore our wide range of medical products and supplies
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {displayCategories.map((category, index) => (
            ...
            >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/60 to-transparent">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {category.subcategories.slice(0, 2).map((sub) => (
                      <span key={sub} className="text-xs text-white/80 bg-white/20 px-2 py-0.5 rounded-full">
                        {sub}
                      </span>
                    ))}
                  </div>
              ...
              {/* Action Button */}
              <div className="p-3">
                <div className={`flex items-center justify-center gap-2 py-3 bg-gradient-to-r ${category.color} text-white rounded-xl font-semibold group-hover:shadow-lg transition-all text-sm`}>

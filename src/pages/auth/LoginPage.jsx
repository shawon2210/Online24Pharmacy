...
export default function LoginPage() {
  ...
  return (
    <>
      <SEOHead
        title="Login - Online24 Pharmacy"
        description="Access your medicine orders"
      />
      <div className="min-h-screen flex flex-col lg:flex-row relative overflow-hidden">
        ...
        {/* Hero */}
        <div className="hidden lg:flex lg:w-2/5 bg-linear-to-br from-emerald-600 via-blue-700 to-purple-900 p-8 xl:p-12 flex-col justify-between relative z-10 shadow-2xl">
          ...
          <div className="space-y-6 relative z-10">
            ...
            <p className="text-xl text-emerald-100 animate-fade-in-delay font-medium">
              Access your medicine orders 24/7
            </p>
        ...
        <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative z-10">
          <div className="w-full max-w-md">
            ...
            >
              <div className="w-14 h-14 bg-linear-to-br from-emerald-600 to-blue-600 rounded-2xl flex items-center justify-center shadow-xl transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                <span className="text-3xl">💊</span>
              </div>
              <span className="text-2xl font-bold bg-linear-to-br from-emerald-400 to-blue-400 bg-clip-text text-transparent">
                Online24
              </span>
            </Link>

            <div className="bg-card/95 backdrop-blur-2xl rounded-3xl shadow-2xl p-8 sm:p-10 border border-card/50 transform hover:scale-[1.01] transition-all duration-300">
              <div className="text-center mb-8">
                <h2 className="text-4xl font-extrabold bg-linear-to-br from-emerald-400 via-blue-400 to-purple-400 bg-clip-text text-transparent mb-3">
                  Sign In
                </h2>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div className="flex items-center">
                  <input
                    id="remember"
                    type="checkbox"
                    className="w-4 h-4 text-emerald-500 bg-card border-muted-foreground rounded focus:ring-emerald-500 transition-all"
                    {...register("remember")}
                  />
                  <label
                    htmlFor="remember"
                    className="ml-2 text-sm text-muted font-semibold"
                  >
              ...
              <div className="mt-8 text-center">
                <p className="text-sm text-muted-foreground font-medium">
                  ...
                  <Link
                    to="/signup"
                    className="font-bold text-transparent bg-clip-text bg-linear-to-br from-emerald-400 to-blue-400 hover:from-emerald-300 hover:to-blue-300 transition-all"
                  >
                    Sign Up →
                  </Link>
                </p>
